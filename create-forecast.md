...
``` output
WARN [2024-07-06 08:37:02] epinow: There were 7 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2024-07-06 08:37:02] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
WARN [2024-07-06 08:37:04] epinow: Bulk Effective Samples Size (ESS) is too low, indicating posterior means and medians may be unreliable.
...
``` output
WARN [2024-07-06 08:46:08] epinow: There were 3 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2024-07-06 08:46:08] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
```
...
``` output
                            measure              estimate
                             <char>                <char>
1:           New infections per day 17038 (9409 -- 31255)
2: Expected change in daily reports     Likely decreasing
3:       Effective reproduction no.    0.87 (0.59 -- 1.3)
4:                   Rate of growth -0.043 (-0.18 -- 0.1)
5:     Doubling/halving time (days)     -16 (6.7 -- -3.8)
```
...
``` output
WARN [2024-07-06 08:46:15] estimate_secondary (chain: 1): Bulk Effective Samples Size (ESS) is too low, indicating posterior means and medians may be unreliable.
Running the chains for more iterations may help. See
https://mc-stan.org/misc/warnings.html#bulk-ess - 
```
...
``` output
WARN [2024-07-06 08:48:21] epinow: There were 3 divergent transitions after warmup. See
https://mc-stan.org/misc/warnings.html#divergent-transitions-after-warmup
to find out why this is a problem and how to eliminate them. - 
WARN [2024-07-06 08:48:21] epinow: Examine the pairs() plot to diagnose sampling problems
 - 
```
...
``` output
                            measure              estimate
                             <char>                <char>
1:           New infections per day        84 (35 -- 213)
2: Expected change in daily reports     Likely increasing
3:       Effective reproduction no.     1.5 (0.83 -- 2.6)
4:                   Rate of growth 0.035 (-0.031 -- 0.1)
5:     Doubling/halving time (days)       20 (6.7 -- -23)
```

El número de reproducción efectivo $R_t$ estimado (en la última fecha de los datos) es 1.5 (0.83 -- 2.6). La tasa de crecimiento exponencial del número de casos es 0.035 (-0.031 -- 0.1).
